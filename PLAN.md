...
| 4. Playwright — completed | Build the minimum structure, automate at least five priority cases, configure request interception, two browsers, tags and reports. | [Playwright execution record](docs/playwright-results.md), `playwright.config.ts`, `tests/`; 12 passed, 2 expected-failing BUG-03 checks and 4 documented `fixme` checks. |
